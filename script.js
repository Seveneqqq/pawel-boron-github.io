...
const portfolioTab = () => {
  ...
  section.innerHTML = "";
    ...
    if(document.getElementsByClassName("home-div").length==0){
      ...
      let txt = "Jestem studentem na Uniwersytecie Śląskim w Katowicach III roku informatyki ze specjalizacją ISI - inżynieria systemów informatycznych. Mój główny stack to HTML+CSS+JS+PHP. W przyszłości chciałbym zostać Frontend developerem lub Programistą FULLSTACK";
